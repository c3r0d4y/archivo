...
class Usuarios_M extends Conexion{
    ...
    function update_usuario_m($idUsuario, $grados, $especialidades, $unidades, $nombreUsuario, $matricula, $usuario, $password, $archivo, $nombreArchivoDB, $estado){
        $column="*";
        $tabla="usuarios";
        ...
        id_unidad=$unidades, usuario = '$usuario', password='$password', estado_usuario=$estado, intentos_usuario=0";
