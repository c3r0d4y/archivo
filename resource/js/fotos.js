...
var insert_evidencia = ()=>{
    document.formEvidencia.action = "insert_foto";
    document.getElementById('img').src="../resource/images/iconos/guardar.png";
    document.getElementById("tituloModal").innerHTML = "¿Desea guardar esta foto?";
...
get_evidencias=()=>{
 ...
 var delete_evidencia = (datos)=>{
    document.formEvidencia.action = "delete_foto";
...
var update_evidencia = (datos)=>{
    document.formEvidencia.action = "update_foto";
    document.getElementById('img').src="../resource/images/iconos/guardar.png";
    document.getElementById("tituloModal").innerHTML = "¿Desea guardar los cambios en esta foto?";
    ...
    if(extension=="jpg" || extension=="png"|| extension=="peg"){path="<img src="+url+">";}
    if(extension=="mp4"){path="<video src="+url+" controls></video>";}
    descripcion=datos[4];
